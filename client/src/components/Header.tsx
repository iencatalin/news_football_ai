const Header = () => {
  const formatDate = new Date().toLocaleDateString('ro-RO', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
    year: 'numeric',
  ...
  return (
    <header>
      ...
      <h1 className='text-7xl font-bold text-center text-slate-900 tracking-[0.7rem]'>
        Ornitorincii
      </h1>
      <div className='flex items-center justify-center max-w-full mx-5 gap-3 py-2'>
        <hr className='flex-1 border-black border' />

        <div className='flex items-center gap-3 text-base font-light uppercase tracking-wide text-text-primary'>
          <span>✦</span>
          <span>știri</span>
          <span>•</span>
          <span>opinii</span>
